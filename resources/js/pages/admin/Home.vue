...
const newSale = (appointmentId = null) => {
            ...
            <el-row :gutter="20">
                <el-col :span="17">
                    <el-row>
                        <el-col :span="24">
                            <el-row :gutter="20">
                                <el-col :lg="8" class="mb-4">
                                    <el-card class="wave wave-animate-slow wave-success cards-home">
                                ...
                                <el-col :lg="8" class="mb-4">
                                    <el-card class="wave wave-animate-slow wave-info cards-home">
                                ...
                                <el-col :lg="8" class="mb-4">
                                    <el-card class="bg-image cards-home">
                                        <el-row :gutter="20">
                                            ...
                                            >
                                                <div
                                                    ...
                                                    :style="{'background-color': s.service.color || '#dc72ff'}"
                                                >
                ...
                <el-col :span="7">
                    <el-row>
                        <el-col :span="24">
                            <el-card class="card-chart mb-4" style="height: 25vh;" body-style="height: 100%; box-sizing: border-box;">
                                <highcharts
                                    :options="chart"
                            ...
                            <el-card class="pt-0 ps-6 pe-6 pb-0">
                                <el-row :gutter="20">
                                    ...
                                    <el-col :span="12" class="mb-3">
                                        <div class="card-warning center-vertical p-4" @click="newAppoiment()">
                                    ...
                                    <el-col :span="12" class="mb-3">
                                        <div class="card-success center-vertical p-4" @click="newAppoiment()">
                                            <div style="display: block;">
                                    ...
                                    <el-col :span="12" class="mb-3">
                                        <div  class="card-danger center-vertical p-4" @click="newSale()">
                                            <div style="display: block;">
                                    ...
                                    <el-col :span="12" class="mb-3">
                                        <div  class="card-info center-vertical p-4" @click="newCustomer()">
                                            <div style="display: block;">

...
<template>
    ...
    <el-col :span="6" class="mb-3">
        <label class="bold">¿Incluir ventas canceladas?</label><br>
        <el-radio-group v-model="options.canceled_sales">
    ...
    <el-col :span="6" class="mb-3">
        <br>
        <el-button type="success" @click="generateSalesReport" :loading="loading">
